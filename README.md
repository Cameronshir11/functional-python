# Functional Python [![](https://github.com/Cameronshir11/functional-python/workflows/tests/badge.svg)](https://github.com/Cameronshir11/functional-python/actions?query=workflow%3Atests)
